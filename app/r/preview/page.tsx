...
const MOCK_DATA: AuditData = {
  ...
  ux: {
    ...
    fields: [
      ...
      { id: "home", label: "Analiza homepage", status: "bun", scor: 100, gasit: ["mesaj clar la inceputul paginii", "meniu de navigare", "categorii si cai spre produse", "adaptat pentru mobil"], lipsa: [], problema: "Homepage-ul e prima impresie.", fix: "Refacem homepage-ul." },
      { id: "categorie", label: "Analiza pagina categorie", status: "partial", scor: 50, gasit: ["grila de produse cu poza si pret", "traseul paginii (stii unde esti)"], lipsa: ["fara paginare vizibila", "fara text de intro (pierzi si SEO)"], problema: "Pagina de categorie e locul unde clientul alege. Fara grila clara, breadcrumbs si text de context, se pierde si pleaca.", fix: "Structuram pagina de categorie: grila poza+pret, breadcrumbs, paginare, text de intro optimizat." },
