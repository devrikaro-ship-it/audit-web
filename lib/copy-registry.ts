...
export const UX_SIGNALS = {
  home_message: { found: "un titlu mare sus spune ce vinzi", missing: "fara un mesaj clar la inceputul paginii", fix: "Pune sus pe prima pagina un titlu mare care spune ce vinzi si pentru cine.", bad: "Prima pagina nu are un titlu mare care sa spuna ce vinzi", problem: "Vizitatorul nu intelege in cateva secunde ce gaseste la tine si pleaca.", good: "Vizitatorul intelege din primul ecran ce vinzi si ramane." },
  home_menu: { found: "meniul cu categoriile se vede sus", missing: "meniu greu de gasit", fix: "Afiseaza meniul cu categoriile principale sus, vizibil si pe telefon.", bad: "Meniul cu categoriile nu se vede sus", problem: "Vizitatorul nu gaseste drumul spre produse si pleaca inainte sa le vada.", good: "Vizitatorul ajunge din meniu la orice categorie." },
  home_paths: { found: fill("prima pagina duce spre categorii si produse (cel putin {homeLinks} legaturi)", UX_LIMITS), missing: "putine cai spre categorii/produse", fix: "Pune pe prima pagina legaturi catre categoriile principale si catre cateva produse vandute des.", bad: fill("Prima pagina are mai putin de {homeLinks} legaturi spre categorii si produse", UX_LIMITS), problem: "Vizitatorul are putine drumuri spre produse, deci vede mai putine si cumpara mai rar.", good: "Vizitatorul are multe drumuri spre produse chiar de pe prima pagina." },
  home_mobile: { found: "pagina se aseaza corect pe telefon", missing: "nu e adaptat pentru mobil", fix: "Foloseste o tema care se aseaza corect pe telefon si verifica paginile principale de pe un telefon.", bad: "Pagina nu se aseaza pe ecranul telefonului", problem: "Pe telefon textul iese mic si trebuie marit, iar cei mai multi vizitatori vin de pe telefon.", good: "Pagina se citeste usor pe telefon, de unde vin cei mai multi vizitatori." },
  cat_grid: { found: "lista de produse arata poza si pretul fiecarui produs", missing: "grila de produse neclara (poza/pret)", fix: "Afiseaza in lista de produse poza si pretul fiecarui produs.", bad: "Lista de produse nu arata poza si pretul fiecarui produs", problem: "Clientul trebuie sa deschida fiecare produs ca sa vada cum arata si cat costa, si renunta.", good: "Clientul compara produsele direct din lista." },
  cat_trail: { found: "traseul paginii (Acasa > Categorie) se vede deasupra titlului", missing: "fara traseul paginii (stii unde esti)", fix: "Afiseaza traseul (Acasa > Categorie > Produs) deasupra titlului, pe categorii si produse.", bad: "Traseul paginii (Acasa > Categorie) nu apare deasupra titlului", problem: "Clientul nu stie unde se afla si se intoarce greu la categorie.", good: "Clientul stie unde se afla si se intoarce usor la categorie." },
  cat_pagination: { found: "lista are numerotarea paginilor sau buton de mai multe produse", missing: "fara paginare vizibila", fix: "Adauga sub lista de produse numerotarea paginilor sau un buton 'Vezi mai multe'.", bad: "Lista de produse nu are numerotarea paginilor sau un buton de mai multe produse", problem: "Clientul vede doar primele produse si nu ajunge la restul.", good: "Clientul ajunge usor la toate produsele din categorie." },
  cat_intro: { found: "categoria are un text de prezentare", missing: "fara text de intro (pierzi si SEO)", fix: "Scrie 2-3 fraze sub titlul categoriei: ce gaseste clientul acolo si cum alege.", bad: "Categoria nu are un text de prezentare", problem: "Clientul nu primeste ajutor sa aleaga, iar Google intelege mai greu categoria.", good: "Clientul e ajutat sa aleaga, iar Google intelege categoria." },
  prod_images: { found: fill("cel putin {productImages} poze pe produs", UX_LIMITS), missing: "prea putine imagini de produs", fix: "Pune cel putin 3-4 poze pe produs: din mai multe unghiuri, in folosire, cu detalii.", bad: fill("Produsul are mai putin de {productImages} poze", UX_LIMITS), problem: "Clientul nu vede produsul din destule unghiuri si nu are incredere sa il cumpere.", good: "Clientul vede produsul din mai multe unghiuri si cumpara cu incredere." },
  prod_price: { found: "pretul si stocul se vad pe pagina produsului", missing: "pret sau stoc neclar", fix: "Afiseaza langa butonul de comanda pretul si daca produsul e in stoc.", bad: "Pretul sau stocul nu se vad pe pagina produsului", problem: "Clientul nu stie cat costa sau daca il primeste, si pleaca sa caute in alta parte.", good: "Clientul stie din prima cat costa si daca e pe stoc." },
  prod_cart: { found: "butonul 'Adauga in cos' se vede clar", missing: "buton de comanda greu de gasit", fix: "Fa butonul 'Adauga in cos' mare si vizibil fara derulare, si pe telefon.", bad: "Butonul 'Adauga in cos' nu se vede clar", problem: "Clientul hotarat sa cumpere nu gaseste butonul si pierzi vanzarea.", good: "Clientul hotarat cumpara dintr-o apasare." },
  prod_description: { found: "produsul are o descriere scrisa", missing: "descriere subtire", fix: "Scrie descrieri care raspund la ce intreaba clientii: la ce foloseste, dimensiuni, material, cum il alegi.", bad: "Produsul nu are o descriere scrisa", problem: "Clientul nu afla ce primeste, asa ca pune intrebari sau renunta.", good: "Clientul afla ce primeste fara sa intrebe." },
  prod_reviews: { found: "recenziile si nota clientilor apar pe produs", missing: "fara recenzii pe produs", fix: "Cere recenzii dupa livrare si afiseaza-le pe pagina produsului.", bad: "Pe pagina produsului nu apar recenzii si nota clientilor", problem: "Fara parerile altor clienti, cumparatorul are mai putina incredere sa comande.", good: "Parerile altor clienti ii dau cumparatorului incredere sa comande." },
  prod_related: { found: "sub produs apar produse similare", missing: "fara produse similare", fix: "Afiseaza sub produs 4-8 produse similare sau complementare.", bad: "Sub produs nu apar produse similare", problem: "Clientul care nu vrea exact acest produs pleaca in loc sa aleaga altul.", good: "Clientul care nu vrea acest produs gaseste imediat o alternativa." },
  filters: { found: "lista se poate filtra dupa pret, marca sau marime", missing: "fara filtre pe categorii", fix: "Adauga filtre dupa pret, marca si caracteristicile principale ale produselor.", bad: "Lista nu se poate filtra dupa pret, marca sau marime", problem: "Clientul trebuie sa parcurga toate produsele ca sa gaseasca ce ii trebuie, si renunta.", good: "Clientul ajunge repede la produsele care i se potrivesc." },
  sort: { found: "lista se poate sorta dupa pret sau popularitate", missing: "fara sortare (pret, popularitate)", fix: "Adauga in lista de produse sortare dupa pret si dupa popularitate.", bad: "Lista nu se poate sorta dupa pret sau popularitate", problem: "Clientul nu poate vedea intai produsele ieftine sau pe cele mai cumparate.", good: "Clientul vede intai produsele care il intereseaza." },
};
...
export const UX_ROWS: Record<string, UxRowCopy> = {
  ...
  viteza_lcp: { title: "Continutul principal apare pe telefon in mai putin de 2,5 s", fix: UX_SITE.lcp.fix, bad: "Continutul principal apare pe telefon dupa mai mult de 2,5 s", problem: "Vizitatorul asteapta pe un ecran gol; la 3 secunde, sansa sa plece creste cu aproape o treime.", good: "Vizitatorul vede continutul aproape imediat." },
  lead_home_offer: { title: "Titlul mare spune ce oferi", fix: "Pune sus pe prima pagina un titlu mare care spune ce servicii oferi si unde.", bad: "Prima pagina nu are un titlu mare care sa spuna ce servicii oferi", problem: "Vizitatorul nu intelege in cateva secunde ce faci si unde, si pleaca.", good: "Vizitatorul intelege din primul ecran ce oferi." },
  lead_home_phone: { title: "Telefonul se vede sus, fara derulare", fix: "Pune telefonul, ca legatura pe care se poate apasa, in antetul paginii, vizibil si pe telefon.", bad: "Telefonul nu se vede sus, fara derulare", problem: "Clientul gata sa sune trebuie sa caute numarul, iar o parte renunta.", good: "Clientul gata sa sune gaseste numarul imediat." },
  lead_home_cta: { title: "Buton de programare sau de contact pe prima pagina", fix: "Pune pe prima pagina un buton vizibil de programare sau de cerere de oferta.", bad: "Prima pagina nu are un buton de programare sau de contact", problem: "Vizitatorul convins nu are un pas clar de facut si amana.", good: "Vizitatorul convins face programarea imediat." },
  srv_explains: { title: "Serviciul e explicat pe pagina", fix: "Explica pe fiecare pagina de serviciu ce este, cui ii foloseste, cum decurge si cat dureaza.", bad: "{n} nu explica serviciul", problem: "Clientul nu intelege ce primeste si nu cere programare.", good: "Clientul intelege serviciul si cere programare." },
  srv_price: { title: "Pretul sau pretul de pornire e afisat", fix: "Afiseaza pe fiecare pagina de serviciu pretul sau pretul de la care porneste.", bad: "{n} nu arata pretul sau pretul de pornire", problem: "Clientul nu stie daca isi permite si prefera un site care arata pretul.", good: "Clientul stie de la inceput cat costa." },
  srv_cta: { title: "Pagina serviciului are buton de programare sau de contact", fix: "Pune pe fiecare pagina de serviciu un buton de programare sau de cerere de oferta, sus si la final.", bad: "{n} nu au buton de programare sau de contact", problem: "Clientul convins de pe pagina serviciului nu are un pas clar si pleaca.", good: "Clientul convins cere programare chiar de pe pagina serviciului." },
  srv_related: { title: "Pagina serviciului duce spre servicii inrudite", fix: "Adauga pe fiecare pagina de serviciu legaturi catre 2-3 servicii inrudite.", bad: "{n} nu duc spre servicii inrudite", problem: "Clientul care cauta altceva pleaca in loc sa gaseasca serviciul potrivit.", good: "Clientul gaseste usor serviciul potrivit." },
  ct_form_short: { title: "Formularul de contact are cel mult cinci campuri", fix: "Pastreaza in formular doar ce iti trebuie ca sa suni inapoi: nume, telefon, serviciul dorit.", bad: "Site-ul nu are un formular scurt de contact, de cel mult cinci campuri", problem: "Un formular lung, sau lipsa lui, ii face pe multi sa renunte la cerere.", good: "Clientul trimite cererea in cateva secunde." },
  ct_call: { title: "Numarul de telefon suna la o atingere", fix: "Fa telefonul o legatura pe care se poate apasa, ca vizitatorul de pe telefon sa sune dintr-o atingere.", bad: "Numarul de telefon nu suna la o atingere", problem: "Pe telefon, clientul trebuie sa copieze numarul, iar o parte renunta.", good: "Clientul suna dintr-o atingere." },
  ct_chat: { title: "Site-ul are WhatsApp sau chat", fix: "Adauga un buton de WhatsApp sau un chat, pentru cei care nu vor sa sune.", bad: "Site-ul nu are WhatsApp sau chat", problem: "Pierzi clientii care nu vor sa sune, dar ar scrie.", good: "Castigi si clientii care prefera sa scrie." },
  ct_map: { title: "Harta si adresa apar pe site", fix: "Pune pe pagina de contact si pe fiecare locatie harta si adresa scrisa.", bad: "Harta si adresa nu apar pe site", problem: "Clientul nu stie cum ajunge la tine si alege pe cineva mai usor de gasit.", good: "Clientul stie exact unde te gaseste." },
  ct_hours: { title: "Programul apare pe site", fix: "Afiseaza programul zi cu zi pe pagina de contact si pe fiecare locatie.", bad: "Programul nu apare pe site", problem: "Clientul nu stie cand poate veni sau suna, si amana.", good: "Clientul stie cand te poate gasi." },
  tr_reviews: { title: "Recenziile clientilor apar pe site", fix: "Afiseaza pe site recenzii reale ale clientilor, cu numele si nota lor.", bad: "Recenziile clientilor nu apar pe site", problem: "Fara parerile altor clienti, vizitatorul are mai putina incredere sa te aleaga.", good: "Parerile altor clienti il conving pe vizitator sa te aleaga." },
  tr_team: { title: "Echipa e prezentata pe site", fix: "Prezinta echipa: medicii sau specialistii, cu poza si experienta.", bad: "Echipa nu e prezentata pe site", problem: "Clientul nu stie cui isi da increderea si alege pe cineva care se prezinta.", good: "Clientul stie cine il trateaza si are incredere." },
  tr_certs: { title: "Certificarile sau partenerii apar pe site", fix: "Arata certificarile, acreditarile si partenerii, cu sigla lor.", bad: "Certificarile sau partenerii nu apar pe site", problem: "Clientul nu vede dovezi ca esti pregatit si te compara cu altii.", good: "Clientul vede dovezi ca esti pregatit." },
  tr_photos: { title: "Poze reale ale locului si ale echipei", fix: "Foloseste poze facute la tine, nu poze cumparate: locul, echipa, aparatura.", bad: "Site-ul nu are poze reale ale locului si ale echipei", problem: "Pozele cumparate nu inspira incredere, iar clientul nu stie la ce sa se astepte.", good: "Clientul vede cum arata locul si echipa si vine cu incredere." },
};

// How to fix each thing a page type is missing, keyed by the signal as the report shows it.
// ── The sections each page type needs to sell (spec 2026-09-26 §2), judged by the AI on the screenshots. Row id:
// st_<kind>_<page>_<section>. ──
export const UX_SECTIONS: Record<string, UxRowCopy> = {
  st_ecom_home_hero: { title: "Primul ecran spune ce vinzi si duce spre produse", bad: "Primul ecran nu spune clar ce vinzi si nu are un buton spre produse", problem: "Vizitatorul nu intelege in cateva secunde de ce e aici si pleaca.", good: "Vizitatorul intelege imediat ce vinzi si merge spre produse.", fix: "Pune sus un titlu cu beneficiul principal si un buton catre produsele sau categoriile cele mai cautate." },
  st_ecom_home_incredere: { title: "Sub primul ecran apar livrarea, returul, plata si garantia", bad: "Pagina nu arata sus livrarea, returul, plata sau garantia", problem: "Cumparatorul nu stie ce il costa si ce riscuri are, asa ca amana comanda.", good: "Cumparatorul afla din prima ca poate comanda fara griji.", fix: "Adauga sub primul ecran o bara cu livrarea, returul, metodele de plata si garantia." },
  st_ecom_home_categorii: { title: "Categoriile principale apar cu poze", bad: "Categoriile principale nu apar pe prima pagina", problem: "Vizitatorul nu vede ce gama ai si nu stie de unde sa inceapa.", good: "Vizitatorul vede gama si intra direct in categoria care il intereseaza.", fix: "Pune pe prima pagina categoriile principale, fiecare cu o poza si un nume clar." },
  st_ecom_home_populare: { title: "Produsele populare apar pe prima pagina", bad: "Prima pagina nu arata produsele cele mai cumparate", problem: "Vizitatorul nu vede ce aleg altii si pierzi cel mai scurt drum spre o comanda.", good: "Vizitatorul ajunge direct la produsele care se vand cel mai bine.", fix: "Adauga o sectiune cu produsele cele mai vandute, cu poza, pret si buton." },
  st_ecom_home_de_ce_noi: { title: "Pagina spune de ce sa cumperi de la tine", bad: "Pagina nu spune de ce sa cumperi de la tine si nu de la altul", problem: "Cumparatorul te compara doar dupa pret si pleaca la cel mai ieftin.", good: "Cumparatorul stie ce castiga alegandu-te pe tine.", fix: "Scrie 3-4 motive clare: selectia, sfatul, livrarea, garantia, service-ul." },
  st_ecom_home_recenzii: { title: "Pe prima pagina apar recenzii si dovezi", bad: "Prima pagina nu arata recenzii sau alte dovezi", problem: "Un vizitator nou nu are motive sa aiba incredere in magazin.", good: "Parerile altor clienti ii dau incredere unui vizitator nou.", fix: "Afiseaza cateva recenzii reale, nota medie si numarul de clienti." },
  st_ecom_home_subsol: { title: "Subsolul are contactul, livrarea, returul si platile", bad: "Subsolul nu are contactul, livrarea, returul sau platile", problem: "Cine cauta raspunsuri inainte de comanda nu le gaseste si renunta.", good: "Cine cauta raspunsuri inainte de comanda le gaseste imediat.", fix: "Pune in subsol telefonul, emailul, livrarea, returul si metodele de plata." },
  st_ecom_categorie_titlu_intro: { title: "Categoria are un titlu si un text scurt de inceput", bad: "Categoria nu are un text scurt de inceput sub titlu", problem: "Cumparatorul nu primeste niciun ajutor sa aleaga, iar Google intelege mai greu pagina.", good: "Cumparatorul intelege categoria si e ajutat sa aleaga.", fix: "Scrie sub titlu 2-3 fraze: ce gaseste clientul aici si cum alege." },
  st_ecom_categorie_filtre: { title: "Lista are filtre si sortare", bad: "Lista nu are filtre si sortare vizibile", problem: "Cumparatorul parcurge tot ca sa gaseasca ce ii trebuie si renunta pe drum.", good: "Cumparatorul ajunge repede la produsele potrivite.", fix: "Pune filtre dupa pret, marca si caracteristici si sortare dupa pret si popularitate, vizibile si pe telefon." },
  st_ecom_categorie_grila: { title: "Fiecare produs din lista arata pret, reducere, nota si stoc", bad: "Produsele din lista nu arata pretul, reducerea, nota sau stocul", problem: "Cumparatorul nu poate compara din lista si deschide produse la intamplare.", good: "Cumparatorul compara si alege direct din lista.", fix: "Afiseaza pe fiecare produs din lista poza, pretul, reducerea, nota si daca e pe stoc." },
  st_ecom_categorie_ghid: { title: "La finalul listei exista un ghid de alegere sau intrebari frecvente", bad: "Lista nu are un ghid de alegere sau intrebari frecvente", problem: "Cumparatorul nehotarat nu primeste raspunsuri si amana decizia.", good: "Cumparatorul nehotarat gaseste raspunsurile si alege.", fix: "Adauga sub lista un scurt ghid de alegere si 3-5 intrebari frecvente." },
  st_ecom_categorie_inrudite: { title: "Pagina duce spre categorii sau produse inrudite", bad: "Pagina nu duce spre categorii sau produse inrudite", problem: "Cumparatorul care nu gaseste aici pleaca in loc sa caute alaturi.", good: "Cumparatorul gaseste usor alternative alaturi.", fix: "Adauga legaturi catre categoriile inrudite si catre produse complementare." },
  st_ecom_produs_galerie: { title: "Produsul are o galerie de poze", bad: "Produsul nu are o galerie de poze", problem: "Cumparatorul vede produsul dintr-un singur unghi si nu are incredere sa comande.", good: "Cumparatorul vede produsul in detaliu inainte sa comande.", fix: "Pune 4-6 poze: din mai multe unghiuri, in folosire, cu detalii si cu dimensiunile." },
  st_ecom_produs_nume_pret: { title: "Numele, pretul si nota apar sus, impreuna", bad: "Numele, pretul sau nota nu apar sus, impreuna", problem: "Cumparatorul trebuie sa caute pretul si nota, iar o parte pleaca.", good: "Cumparatorul vede dintr-o privire ce e, cat costa si cum e apreciat.", fix: "Pune sus, langa poze, numele produsului, pretul si nota clientilor." },
  st_ecom_produs_variante_buton: { title: "Variantele si butonul de cumparare sunt evidente", bad: "Variantele sau butonul de cumparare nu sunt evidente", problem: "Cumparatorul hotarat nu stie cum sa aleaga sau unde sa apese, si pierzi comanda.", good: "Cumparatorul alege varianta si comanda fara sa caute.", fix: "Afiseaza variantele ca butoane si pune butonul de cumparare mare si vizibil, langa pret." },
  st_ecom_produs_livrare_retur: { title: "Langa buton apar livrarea, returul si garantia", bad: "Langa buton nu apar costul si termenul livrarii, returul sau garantia", problem: "Costurile aflate abia la final sunt motivul numarul unu pentru care cumparatorii abandoneaza cosul.", good: "Cumparatorul stie de la inceput cat il costa si cand primeste produsul.", fix: "Scrie langa buton costul si termenul livrarii, returul si garantia." },
  st_ecom_produs_beneficii: { title: "Beneficiile produsului apar pe puncte", bad: "Produsul nu are beneficiile scrise pe puncte", problem: "Cumparatorul nu vede repede de ce i-ar folosi produsul si nu se convinge.", good: "Cumparatorul intelege in cateva secunde de ce i-ar folosi.", fix: "Scrie 3-5 beneficii pe puncte, sus, langa pret." },
  st_ecom_produs_descriere: { title: "Produsul are descriere si specificatii", bad: "Produsul nu are descriere sau specificatii", problem: "Cumparatorul nu afla detaliile de care are nevoie, asa ca intreaba sau renunta.", good: "Cumparatorul gaseste toate detaliile pe pagina.", fix: "Adauga o descriere care raspunde la intrebarile clientilor si un tabel cu specificatiile." },
  st_ecom_produs_recenzii: { title: "Produsul are recenzii pe pagina", bad: "Produsul nu are recenzii pe pagina", problem: "Fara parerile altor cumparatori, produsul pare riscant.", good: "Parerile altor cumparatori fac produsul sigur de ales.", fix: "Cere recenzii dupa livrare si arata-le pe pagina produsului, cu nota." },
  st_ecom_produs_similare: { title: "Sub produs apar produse similare sau cumparate impreuna", bad: "Sub produs nu apar produse similare sau cumparate impreuna", problem: "Pierzi cumparatorii care vor altceva si comenzile cu mai multe produse.", good: "Cumparatorul gaseste alternative si adauga produse complementare.", fix: "Adauga sub produs produse similare si produse cumparate des impreuna." },
  st_leads_home_hero: { title: "Primul ecran spune rezultatul pentru client, unde esti si cum faci programarea", bad: "Primul ecran nu spune ce rezultat obtine clientul, unde esti sau cum face programarea", problem: "Vizitatorul nu intelege in cateva secunde de ce sa te aleaga si pleaca.", good: "Vizitatorul intelege imediat ce obtine si face programarea.", fix: "Pune sus un titlu cu rezultatul pentru client, orasul sau zona si un buton de programare sau telefonul." },
  st_leads_home_incredere: { title: "Sub primul ecran apar anii de experienta, clientii si nota Google", bad: "Pagina nu arata sus anii de experienta, numarul de clienti sau nota Google", problem: "Vizitatorul nu are motive rapide sa aiba incredere in tine.", good: "Vizitatorul vede din prima ca multi te-au ales inainte.", fix: "Adauga sub primul ecran o bara cu anii de experienta, numarul de clienti si nota Google." },
  st_leads_home_servicii: { title: "Serviciile principale apar pe prima pagina", bad: "Serviciile principale nu apar pe prima pagina", problem: "Vizitatorul nu vede repede ce faci si nu gaseste serviciul cautat.", good: "Vizitatorul gaseste imediat serviciul de care are nevoie.", fix: "Pune pe prima pagina serviciile principale, fiecare cu un titlu, o fraza si o legatura." },
  st_leads_home_de_ce_noi: { title: "Pagina spune de ce sa te aleaga pe tine", bad: "Pagina nu spune de ce sa te aleaga pe tine si nu pe altul", problem: "Clientul te compara doar dupa pret si alege pe altcineva.", good: "Clientul stie ce castiga alegandu-te pe tine.", fix: "Scrie 3-4 motive clare: experienta, aparatura, rapiditatea, garantia." },
  st_leads_home_rezultate: { title: "Pagina arata rezultate: inainte si dupa, cazuri", bad: "Pagina nu arata rezultate: inainte si dupa sau cazuri", problem: "Clientul nu vede ce poti face pentru el si ramane nesigur.", good: "Clientul vede rezultate reale si isi imagineaza propriul rezultat.", fix: "Adauga cateva cazuri reale, cu poze inainte si dupa, cu acordul clientilor." },
  st_leads_home_echipa: { title: "Echipa apare pe prima pagina", bad: "Echipa nu apare pe prima pagina", problem: "Clientul nu stie cine il va trata si alege pe cineva care se prezinta.", good: "Clientul cunoaste echipa inainte sa vina.", fix: "Prezinta pe scurt echipa: poza, nume, specializare si experienta." },
  st_leads_home_recenzii: { title: "Pe prima pagina apar recenziile clientilor", bad: "Prima pagina nu arata recenziile clientilor", problem: "Un vizitator nou nu are dovezi ca altii au fost multumiti.", good: "Recenziile il conving pe vizitatorul nou sa te aleaga.", fix: "Afiseaza recenzii reale, cu nume si nota, sau recenziile tale din Google." },
  st_leads_home_proces: { title: "Pagina arata cum decurge colaborarea, pe pasi", bad: "Pagina nu arata cum decurge colaborarea", problem: "Clientul nu stie ce il asteapta si amana primul pas.", good: "Clientul stie exact ce urmeaza si face primul pas usor.", fix: "Descrie in 3-4 pasi ce se intampla de la programare pana la rezultat." },
  st_leads_home_intrebari: { title: "Pagina raspunde la intrebarile frecvente", bad: "Pagina nu raspunde la intrebarile frecvente", problem: "Clientul cu intrebari nu primeste raspuns si nu te suna.", good: "Clientul isi gaseste raspunsurile si se hotaraste.", fix: "Adauga 5-8 intrebari frecvente despre pret, durata, durere si programare." },
  st_leads_home_final: { title: "Pagina se incheie cu un indemn la programare si datele de contact", bad: "Pagina nu se incheie cu un indemn la programare si datele de contact", problem: "Vizitatorul convins la finalul paginii nu are un pas clar de facut.", good: "Vizitatorul convins face programarea chiar de la finalul paginii.", fix: "Pune la final un buton de programare, telefonul, adresa si programul." },
  st_leads_serviciu_hero: { title: "Primul ecran spune serviciul, rezultatul si are un buton", bad: "Primul ecran nu spune serviciul si rezultatul sau nu are un buton", problem: "Vizitatorul nu intelege repede ce obtine din acest serviciu si pleaca.", good: "Vizitatorul intelege repede serviciul si cere programare.", fix: "Pune sus numele serviciului, rezultatul pentru client si un buton de programare." },
  st_leads_serviciu_pentru_cine: { title: "Pagina spune pentru cine e serviciul si ce problema rezolva", bad: "Pagina nu spune pentru cine e serviciul si ce problema rezolva", problem: "Clientul nu stie daca serviciul i se potriveste si nu cere programare.", good: "Clientul se recunoaste in problema si stie ca serviciul e pentru el.", fix: "Scrie cui ii foloseste serviciul si ce problema rezolva, in cuvintele clientului." },
  st_leads_serviciu_beneficii: { title: "Pagina arata beneficiile serviciului", bad: "Pagina nu arata beneficiile serviciului", problem: "Clientul vede ce faci, dar nu ce castiga el, si nu se convinge.", good: "Clientul intelege ce castiga din serviciu.", fix: "Scrie 3-5 beneficii concrete ale serviciului, pe puncte." },
  st_leads_serviciu_pasi: { title: "Pagina arata cum decurge serviciul, pe pasi", bad: "Pagina nu arata cum decurge serviciul", problem: "Clientul nu stie ce il asteapta si ii e teama sa inceapa.", good: "Clientul stie ce urmeaza si vine linistit.", fix: "Descrie pe pasi cum decurge serviciul si cat dureaza fiecare pas." },
  st_leads_serviciu_pret: { title: "Pagina arata pretul sau pretul de pornire", bad: "Pagina nu spune cat costa serviciul", problem: "Clientul nu stie daca isi permite si alege un site care arata pretul.", good: "Clientul stie de la inceput cat costa si nu are surprize.", fix: "Afiseaza pretul sau pretul de la care porneste serviciul." },
  st_leads_serviciu_rezultate: { title: "Pagina arata rezultatele serviciului", bad: "Pagina nu arata rezultatele serviciului", problem: "Clientul nu vede ce rezultat poate astepta si ramane nehotarat.", good: "Clientul vede rezultatul pe care il poate avea.", fix: "Adauga cazuri reale ale serviciului, cu poze inainte si dupa." },
  st_leads_serviciu_recenzii: { title: "Pagina serviciului are recenzii", bad: "Pagina serviciului nu are recenzii", problem: "Clientul nu vede ca altii au fost multumiti de acest serviciu.", good: "Recenziile despre serviciu il conving pe client.", fix: "Afiseaza pe pagina recenziile clientilor care au facut acest serviciu." },
  st_leads_serviciu_intrebari: { title: "Pagina raspunde la intrebari si obiectii: pret, durere, durata", bad: "Pagina nu raspunde la intrebari si obiectii", problem: "Obiectiile ramase fara raspuns il opresc pe client sa ceara programare.", good: "Clientul primeste raspuns la temeri si cere programare.", fix: "Adauga intrebari frecvente despre pret, durere, durata si recuperare." },
  st_leads_serviciu_final: { title: "Pagina se incheie cu un buton de programare", bad: "Pagina serviciului nu se incheie cu un buton de programare", problem: "Clientul convins dupa ce a citit totul nu are un pas clar de facut.", good: "Clientul convins cere programare imediat ce termina de citit.", fix: "Pune la finalul paginii un buton de programare si telefonul." },
  st_leads_serviciu_inrudite: { title: "Pagina duce spre servicii inrudite", bad: "Pagina nu duce spre servicii inrudite", problem: "Clientul care are nevoie de altceva pleaca in loc sa gaseasca serviciul potrivit.", good: "Clientul gaseste usor si alte servicii de care are nevoie.", fix: "Adauga legaturi catre 2-3 servicii inrudite." },
  st_leads_contact_promisiune: { title: "Pagina spune ce se intampla dupa trimitere", bad: "Pagina nu spune ce se intampla dupa ce trimiti cererea", problem: "Clientul nu stie cand il suni si ezita sa trimita cererea.", good: "Clientul stie cand va fi contactat si trimite cererea linistit.", fix: "Scrie langa formular ce urmeaza, de exemplu: te sunam in 24 de ore." },
  st_leads_contact_formular: { title: "Pagina are un formular scurt", bad: "Pagina de contact nu are un formular scurt", problem: "Clientul care nu vrea sa sune nu are cum sa ceara programare.", good: "Clientul cere programare in cateva secunde, fara sa sune.", fix: "Pune un formular cu cel mult cinci campuri: nume, telefon, serviciu, mesaj." },
  st_leads_contact_canale: { title: "Pagina are telefon, WhatsApp si email", bad: "Pagina nu are toate canalele: telefon, WhatsApp si email", problem: "Clientul nu te poate contacta pe canalul pe care il prefera.", good: "Clientul te contacteaza cum ii e mai usor.", fix: "Afiseaza telefonul ca legatura, un buton de WhatsApp si adresa de email." },
  st_leads_contact_harta_program: { title: "Pagina are harta, adresa si programul", bad: "Pagina nu are harta, adresa sau programul", problem: "Clientul nu stie unde si cand sa vina.", good: "Clientul stie exact unde si cand sa vina.", fix: "Pune harta, adresa scrisa si programul zi cu zi." },
  st_leads_contact_recenzii: { title: "Langa formular apar recenzii", bad: "Langa formular nu apar recenzii", problem: "Clientul ezita chiar inainte de trimitere, fara o dovada in plus.", good: "O recenzie langa formular il ajuta pe client sa trimita cererea.", fix: "Pune 2-3 recenzii scurte langa formular." },
};

// ── Design and content, judged by the AI per page type (spec 2026-09-26 §3): the title by grade and kind; what the
// model saw, the impact and the fix are its own words, shown through UI.aiSeen, whyBadLine and problemsFix. ──
// In the order of the grades: leads to it, only partly, not at all (AiJudgement["grade"]: bun, de-reglat, rau).
export const UX_AI = {
  design: {
    ecom: ["Designul paginii duce spre vanzare", "Designul paginii duce doar partial spre vanzare", "Designul paginii e doar decor, nu duce spre vanzare"],
    leads: ["Designul paginii duce spre programare", "Designul paginii duce doar partial spre programare", "Designul paginii e doar decor, nu duce spre programare"],
  },
  content: {
    ecom: ["Textele si dovezile paginii vand", "Textele paginii vand doar partial", "Textele paginii doar prezinta informatii, nu vand"],
    leads: ["Textele si dovezile paginii aduc programari", "Textele paginii aduc programari doar partial", "Textele paginii doar prezinta informatii, nu aduc programari"],
  },
};
...
export const UI = {
  ...
  aiSeen: "Ce am vazut: {seen}",
  aiEvaluated: "evaluat pe capturi",
  withHow: "{result} · {how}",
