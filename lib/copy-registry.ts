...
export const ROWS: Record<string, RowCopy> = {
  pagini_200: { title: "Paginile citite se deschid fara eroare", unit: UNIT.pagini, problem: "Unele pagini citite raspund cu eroare: nu exista sau serverul da gres.", fix: "Repara paginile cu eroare sau trimite-le automat catre cea mai apropiata pagina care exista." },
  https: { title: "Tot site-ul se deschide pe conexiune securizata (https)", unit: UNIT.none, problem: "Site-ul se deschide si pe http, fara conexiune securizata, fara sa trimita automat pe https.", fix: "Trimite automat orice adresa http:// catre varianta https://." },
  redirect_scurt: { title: "Adresa scrisa cu http sau cu www ajunge la site in cel mult doi pasi", unit: UNIT.none, problem: "O varianta a adresei (cu http sau cu www) trece prin trei sau mai multe redirectionari pana ajunge la site.", fix: "Fa ca fiecare varianta a adresei sa trimita direct la adresa finala a site-ului." },
  acces_server: { title: "Site-ul nu blocheaza vizitele automate, cum sunt ale lui Google", unit: UNIT.none, problem: "Site-ul a refuzat cererile serverului nostru; unele protectii refuza si robotii Google sau ai asistentilor AI.", fix: "Verifica in setarile de protectie (Cloudflare, firewall) ca Googlebot, Bingbot si robotii de cautare AI au acces." },
  robots_exista: { title: "Site-ul are fisierul robots.txt, cu regulile pentru Google", unit: UNIT.none, problem: "Site-ul nu are fisierul robots.txt, care le spune robotilor ce pot citi.", fix: "Publica la /robots.txt regulile pentru roboti si adresa listei de pagini." },
  robots_motoare: { title: "robots.txt ii lasa pe Google si Bing sa citeasca site-ul", unit: "motoare de cautare", problem: "robots.txt opreste Google sau Bing sa citeasca site-ul.", fix: "Scoate din robots.txt regula care opreste Googlebot sau Bingbot." },
  robots_pagini: { title: "robots.txt nu blocheaza categoriile, produsele sau fisierele care dau aspectul paginii", unit: "adrese", problem: "robots.txt blocheaza categorii, produse sau fisierele care dau aspectul paginii, asa ca Google nu le poate citi.", fix: "Scoate din robots.txt regulile care blocheaza categoriile, produsele sau fisierele care dau aspectul paginii." },
  robots_sitemap: { title: "robots.txt spune unde e lista de pagini", unit: UNIT.none, problem: "robots.txt nu spune robotilor unde e lista de pagini (sitemap).", fix: "Adauga in robots.txt linia Sitemap: cu adresa listei de pagini." },
  sitemap_exista: { title: "Site-ul are lista de pagini pentru Google", unit: UNIT.none, problem: "Site-ul nu are o lista de pagini pentru Google (sitemap), asa ca Google afla mai greu de pagini.", fix: "Activeaza lista de pagini din platforma sau din modulul SEO si trimite-o in Google Search Console." },
  ...
  sitemap_valide: { title: "Lista nu contine pagini sterse sau mutate", unit: "adrese verificate", problem: "Lista contine adrese care nu duc direct la o pagina: sunt sterse sau redirectionate.", fix: "Scoate din lista paginile sterse si pune in locul celor redirectionate adresa lor finala." },
  ...
  fara_noindex: { title: "Nicio categorie sau produs nu e ascuns de Google", unit: UNIT.pagini, problem: "Unele pagini de categorie sau de produs sunt marcate sa nu apara in Google.", fix: "Scoate marcajul care ascunde paginile de categorie si de produs; lasa-l doar pe cos, cont si cautarea din site." },
  canonical_propriu: { title: "Fiecare pagina ii arata lui Google propria adresa, nu pe a alteia", unit: UNIT.pagini, problem: "Unele pagini nu isi declara propria adresa ca adresa principala sau trimit Google la alta pagina, asa ca pot lipsi din rezultate.", fix: "Fa ca fiecare categorie si fiecare produs sa-si declare propria adresa ca adresa principala." },
  www_unic: { title: "Site-ul se deschide la o singura adresa, cu www sau fara, nu la amandoua", unit: UNIT.none, problem: "Site-ul se deschide separat si cu www si fara www, asa ca Google il poate vedea de doua ori.", fix: "Alege o varianta, cu sau fara www, si trimite-o automat pe cealalta la ea." },
  parametri: { title: "O categorie sortata (de exemplu dupa pret) nu apare in Google ca pagina separata", unit: UNIT.none, problem: "O categorie sortata (de exemplu dupa pret) apare ca pagina separata, asa ca Google vede aceeasi lista de mai multe ori.", fix: "Fa ca paginile sortate sau filtrate sa declare categoria de baza ca adresa principala." },
  html_nume: { title: "Numele produsului e scris direct in pagina", unit: UNIT.pagini_produs, problem: "Numele produsului nu e in codul trimis de server, asa ca ChatGPT si Claude nu il vad.", fix: "Afiseaza numele produsului direct in pagina, nu incarcat dupa deschidere prin JavaScript." },
  html_pret: { title: "Pretul e scris direct in pagina", unit: UNIT.pagini_produs, problem: "Pretul nu e in codul trimis de server, asa ca asistentii AI nu il vad.", fix: "Afiseaza pretul direct in pagina, nu incarcat dupa deschidere prin JavaScript." },
  html_descriere: { title: fill("Produsul are descriere scrisa in pagina, de cel putin {ownText} de caractere", SEO_LIMITS), unit: UNIT.pagini_produs, problem: "Paginile de produs fara descriere proprie nu le spun clientilor, lui Google si asistentilor AI ce vinzi.", fix: "Scrie pentru fiecare produs o descriere proprie: la ce foloseste, dimensiuni, material, cum il alegi." },
  ...
  titlu_unic: { title: "Nicio pagina nu are acelasi titlu ca alta", unit: UNIT.pagini, problem: "Paginile cu acelasi titlu se incurca in Google: nu stie pe care sa o arate.", fix: "Da fiecarei pagini un titlu propriu." },
  ...
  descriere_unica: { title: "Nicio pagina nu are aceeasi descriere ca alta", unit: UNIT.pagini, problem: "Paginile cu aceeasi descriere arata la fel in rezultatele Google.", fix: "Scrie o descriere proprie pentru fiecare pagina." },
  ...
  text_propriu: { title: "Textul fiecarei pagini nu e copiat de pe alta pagina", unit: UNIT.pagini, problem: "Textul copiat de pe alta pagina a magazinului nu ajuta nicio pagina sa urce in Google.", fix: "Scrie text propriu pentru fiecare pagina, incepand cu produsele cele mai vandute." },
  text_categorii: { title: fill("Categoriile au text de prezentare de cel putin {ownText} de caractere", SEO_LIMITS), unit: NOUN.category[1], problem: "Categoriile au doar lista de produse, fara text propriu, desi ele prind cautarile mari.", fix: "Scrie 2-3 paragrafe pe fiecare categorie: ce gaseste clientul acolo si cum alege." },
  alt_imagini: { title: "Pozele produselor au un text care spune ce arata", unit: UNIT.pagini_produs, problem: "Poza produsului nu are descriere, asa ca Google Imagini si asistentii AI nu stiu ce arata.", fix: "Completeaza descrierea (textul alternativ) fiecarei poze de produs cu numele produsului." },
  schema_firma: { title: "Google primeste numele, logo-ul si contactul magazinului", unit: UNIT.none, problem: "Site-ul nu declara pentru Google datele firmei: nume, logo, contact.", fix: "Activeaza datele firmei din modulul SEO sau din tema." },
  schema_produs: { title: "Google primeste pretul si stocul fiecarui produs", unit: UNIT.pagini_produs, problem: "Fara pret si stoc declarate, produsele nu apar in rezultatele Google cu pret.", fix: "Activeaza datele de produs (pret, moneda, stoc) pe toate paginile de produs." },
  schema_rating: { title: "Google primeste nota clientilor, ca sa arate stele", unit: UNIT.pagini_produs, problem: "Fara nota clientilor declarata, langa produse nu apar stele in Google.", fix: "Cere recenzii dupa livrare si afiseaza-le pe pagina produsului, cu nota inclusa in datele pentru Google; stelele apar doar din recenzii reale." },
  schema_traseu: { title: "Google primeste traseul paginii (Acasa > Categorie > Produs)", unit: UNIT.pagini, problem: "Traseul (Acasa > Categorie > Produs) nu e declarat pentru Google.", fix: "Activeaza traseul in datele pentru Google, din modulul SEO sau din tema." },
  schema_livrare: { title: "Google primeste costul livrarii si politica de retur", unit: UNIT.pagini_produs, problem: "Livrarea si returul nu sunt declarate, desi Google le arata langa pret.", fix: "Adauga in datele de produs costul livrarii si politica de retur." },
  schema_pret_vizibil: { title: "Pretul trimis lui Google e acelasi cu cel afisat", unit: UNIT.pagini_produs, problem: "Pretul declarat pentru Google difera de cel afisat, iar Google poate respinge datele.", fix: "Fa ca pretul din datele pentru Google sa fie exact pretul afisat pe pagina." },
  ...
  ai_profiluri: { title: "Site-ul are legaturi catre profilurile oficiale ale firmei", unit: UNIT.legaturi, problem: "Paginile nu leaga magazinul de profilurile oficiale ale firmei (Facebook, Instagram), asa ca asistentii AI il recunosc mai greu.", fix: "Adauga in datele firmei pentru Google legaturile catre profilurile oficiale." },
};
...
export const ROWS_LEADS: Record<string, Partial<RowCopy>> = {
  ...
  robots_pagini: { title: "robots.txt nu blocheaza paginile de servicii, de locatii sau fisierele care dau aspectul paginii", problem: "robots.txt blocheaza pagini de servicii, de locatii sau fisierele care dau aspectul paginii, asa ca Google nu le poate citi.", fix: "Scoate din robots.txt regulile care blocheaza paginile de servicii, de locatii sau fisierele care dau aspectul paginii." },
  fara_noindex: { title: "Nicio pagina de serviciu sau de locatie nu e ascunsa de Google", problem: "Unele pagini de servicii sau de locatii sunt marcate sa nu apara in Google.", fix: "Scoate marcajul care ascunde paginile de servicii si de locatii; lasa-l doar pe paginile de confirmare si pe cele interne." },
  canonical_propriu: { fix: "Fa ca fiecare pagina de serviciu si de locatie sa-si declare propria adresa ca adresa principala." },
  html_serviciu: { title: "Numele serviciului e scris direct in pagina", unit: UNIT.pagini_servicii, problem: "Numele serviciului nu e in codul trimis de server, asa ca ChatGPT si Claude nu il vad.", fix: "Afiseaza numele serviciului ca titlu mare direct in pagina, nu incarcat dupa deschidere prin JavaScript." },
  html_contact: { title: "Telefonul si adresa sunt scrise direct in pagina", unit: UNIT.pagini, problem: "Pe unele pagini de servicii sau de locatii telefonul (ca legatura pe care se poate apasa) sau adresa lipsesc din codul trimis de server.", fix: "Pune pe fiecare pagina de serviciu si de locatie telefonul ca legatura pe care se poate apasa si adresa scrisa, nu intr-o imagine." },
  html_descriere_serviciu: { title: fill("Serviciul are descriere scrisa in pagina, de cel putin {ownText} de caractere", SEO_LIMITS), unit: UNIT.pagini_servicii, problem: "Paginile de servicii fara descriere proprie nu le spun clientilor, lui Google si asistentilor AI ce oferi.", fix: "Scrie pentru fiecare serviciu ce este, cui ii foloseste, cum decurge si cat dureaza." },
  ...
  locatii_diferite: { title: "Paginile de locatii nu copiaza acelasi text", unit: UNIT.pagini_locatii, problem: "Unele pagini de locatii repeta textul altei locatii si schimba doar numele zonei, iar Google le poate trata ca pagini fara valoare.", fix: "Scrie pentru fiecare locatie ce e specific acolo: adresa, cum ajungi, program, echipa, ce servicii sunt disponibile." },
  schema_firma: { title: "Google primeste numele, logo-ul si contactul firmei" },
  schema_afacere_locala: { title: "Google primeste adresa si telefonul afacerii", unit: UNIT.none, problem: "Site-ul nu se declara pentru Google ca afacere locala (clinica, cabinet, firma de servicii) cu adresa si telefon.", fix: "Declara in datele pentru Google tipul exact al afacerii (de exemplu clinica sau cabinet), adresa si telefonul, din modulul SEO." },
  schema_program: { title: "Google primeste programul afacerii", unit: UNIT.none, problem: "Programul nu e declarat pentru Google, asa ca nu apare langa numele afacerii in rezultate.", fix: "Adauga programul in datele afacerii locale, zi cu zi, din modulul SEO." },
  ...
  schema_traseu: { title: "Google primeste traseul paginii (Acasa > Servicii > Serviciu)", problem: "Traseul (Acasa > Servicii > Serviciu) nu e declarat pentru Google." },
  ...
  ai_profiluri: { problem: "Paginile nu leaga site-ul de profilurile oficiale ale firmei (Facebook, Instagram), asa ca asistentii AI il recunosc mai greu." },
};
